...
--
-- Host: 127.0.0.1
-- Creato il: Set 21, 2020 alle 15:47
...
--
CREATE DATABASE IF NOT EXISTS `concertedia` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `concertedia`;
...
('(I Can’t Get No) Satisfaction', 'Rock', '03:44:00'),
('3/5 Of a Mile in 10 Seconds', 'Rock', '05:31:00'),
('50 Ways to Leave Your Lover', 'Folk', '00:04:23'),
('A Heart in New York', 'Folk', '00:02:49'),
('A Kind of Magic', 'Vocal ', '00:08:33'),
('A Saucerful of Secrets', 'Rock', '11:57:00'),
...
('Brown Sugar', 'Rock', '03:48:00'),
('Careful with That Axe, Eugene', 'Rock', '03:35:00'),
('Come Back Baby', 'Rock', '06:05:00'),
...
('Introduction (Live At woodstock)', 'Blues', '02:21:00'),
('Is This the World We Created?', 'Rock', '00:02:57'),
('It\'s Only Rock \'n\' Roll (But I Like It)', 'Rock', '05:07:00'),
('Izabella', 'Rock', '06:42:00'),
('Jam Back at the House', 'Blues', '07:46:00'),
('Jingo', 'Rock', '00:06:39'),
('Jumpin’ Jack Flash', 'Rock', '03:39:00'),
...
('White Rabbit', 'Rock', '02:27:00'),
('Who Wants to Live Forever', 'Rock', '00:04:07'),
('Whole Lotta Love', 'Rock', '00:07:26'),
('Wild Horses', 'Rock', '05:41:00'),
('Won\'t You Try / Saturday Afternoon', 'Rock', '05:07:00'),
('Wooden Ships', 'Rock', '21:26:00'),
('Woodstock Improvisation', 'Improvisation', '00:00:04'),
('You Can\'t Always Get What You Want', 'Rock', '04:29:00'),
('You Got Me Rocking', 'Rock', '03:36:00'),
...
('Alan', 'Price', '1942-04-19', NULL, 'The Animals'),
('Art', 'Garfunkel', '1941-11-05', NULL, 'Simon & Garfunkel'),
('Barry', 'Jenkins', '1944-12-22', NULL, 'The Animals'),
...
('Chas', 'Chandler', '1938-12-19', '1996-07-17', 'The Animals'),
('David', 'Gilmour', '1946-03-06', NULL, 'Pink Floyd'),
('Eric', 'Burdon', '1941-05-11', NULL, 'The Animals'),
...
('Hilton', 'Valentine', '1943-05-21', NULL, 'The Animals'),
...
('John', 'Steel', '1941-02-04', NULL, 'The Animals'),
...
CREATE TABLE IF NOT EXISTS `scalette` (
  `Concerto` varchar(30) NOT NULL,
  `Brano` varchar(100) NOT NULL,
  PRIMARY KEY (`Concerto`,`Brano`),
  KEY `song` (`Brano`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE IF NOT EXISTS `suona` (
  ...
  PRIMARY KEY (`Nome_Musicista`,`Cognome_Musicista`,`Strumento`),
  KEY `fk_foreign_key_strum` (`Strumento`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
('Grace', 'Slick', 'Piano'),
('Grace', 'Slick', 'Voce'),
('Hilton', 'Valentine', 'Chitarra solista'),
('Jack', 'Casady', 'Basso'),
